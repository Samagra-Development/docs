...
Just download the file `curl -LJO https://raw.githubusercontent.com/Samagra-Development/psql-deployment/master/docker/docker-compose.pSmall.yml` and then `docker-compose up -d`
